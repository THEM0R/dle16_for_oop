		...
		<div class="meta">
			...
			<div class="rate">
				...
				<div class="rate_like-dislike">
					[rating-plus]<svg title="Подобається" class="icon icon-like"><use xlink:href="#icon-like"></use></svg>[/rating-plus]
					{rating}
					[rating-minus]<svg title="Не подобається" class="icon icon-dislike"><use xlink:href="#icon-dislike"></use></svg>[/rating-minus]
				</div>
				[/rating-type-3]
				[rating-type-4]
				<div class="rate_like-dislike">
			...
			<ul class="left">
				<li class="reply grey" title="Цитувати">[fast]<svg class="icon icon-coms"><use xlink:href="#icon-coms"></use></svg><span>Цитувати</span>[/fast]</li>
				...
				[not-group=5] 
				<li class="edit_btn" title="Редагувати">[com-edit]<i title="Редагувати">Редагувати</i>[/com-edit]</li>
				<li class="del" title="Видалити">[com-del]<svg class="icon icon-cross"><use xlink:href="#icon-cross"></use></svg><span class="title_hide">Видалити</span>[/com-del]</li>
