...
<ul id="login_pane">
	<li class="dropdown">
		<a data-toggle="dropdown" class="btn-border" href="{profile-link}">
			<b class="over">{login}</b><span title="Нові повідомлення - {new-pm}" class="pm_num">{new-pm}</span>
		</a>
		<div class="dropdown-form dot logged">
			<div class="login_pane__info">
				...
				[admin-link]<div class="login_pane__admin"><a href="{admin-link}" target="_blank">Адмінпанель</a></div>[/admin-link]
			</div>
			<ul class="login_pane__menu">
				<li><a href="{pm-link}">Повідомлення <span class="right grey"><b>{new-pm}</b> з {all-pm}</span></a></li>
				<li><a href="{favorites-link}">Закладки <span class="right grey"><b>{favorite-count}</b></span></a></li>
				<li><a href="{newposts-link}">Непрочитані новини</a></li>
			</ul>
			<div class="login_pane__foot">
				<a class="right" href="{logout-link}">Вихід</a>
				<a href="{addnews-link}"><span class="plus_icon circle"><span>+</span></span>Додати новину</a>
			</div>
		</div>
	</li>
</ul>
	...
	<li class="dropdown">
		...
		<form class="dropdown-form dot" method="post">
			...
			<div class="login_form__foot">
				<a class="right" href="{registration-link}"><b>Реєстрація</b></a>
