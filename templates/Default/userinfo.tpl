<article class="box story">
	<div class="box_in dark_top userinfo_top">
		<ul class="title user_tab h1">
			<li class="active"><a href="#user1" data-toggle="tab">[group=5]Користувач [/group]{usertitle}</a></li>
			[not-logged]<li><a href="#user2" data-toggle="tab">Редагувати</a></li>[/not-logged]
		...
		<div class="tab-content">
			<div class="tab-pane active" id="user1">
				...
				<ul class="usinf">
					...
					<li><div class="ui-c1 grey">Рейтинг коментарів</div> <div class="ui-c2">{commentsrate}</div></li>
				</ul>
					...
					<div class="addform">
						<ul class="ui-form">
							...
							<li class="form-group">
								...
								<textarea placeholder="Приклади: 192.48.25.71 або маска 129.42.0.0/16 або з зірочками 129.42.*.*" name="allowed_ip" id="allowed_ip" rows="5" class="field wide">{allowed-ip}</textarea>
							</li>
							[/group]
							<li class="form-group">
								<table class="xfields">
