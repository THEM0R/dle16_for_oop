	...
	<div class="carousel-control">
		<div class="carousel-control_in">
			<a class="up" href="#carousel-main" role="button" data-slide="prev">
				...
				<span class="title_hide">Догори</span>
			</a>
			...
			<a class="down" href="#carousel-main" role="button" data-slide="next">
				...
				<span class="title_hide">Униз</span>
			</a>
		</div>
	</div>
	<div class="carousel-inner" role="listbox">
		<div class="item active">
			<div class="carousel-caption">
				<div class="carousel-caption_in">
					...
					<div class="text">Власний сайт без компромісів!</div>
				</div>
			</div>
		...
		<div class="item">
			<div class="carousel-caption">
				<div class="carousel-caption_in">
					<div class="title">DataLife Engine</div>
					<div class="text">Власний сайт легко і зручно!</div>
				</div>
			</div>
		...
		<div class="item">
			<div class="carousel-caption">
				<div class="carousel-caption_in">
					<div class="title">DataLife Engine</div>
					<div class="text">Власний сайт: найшвидший та з мінімальним навантаженням!</div>
				</div>
			</div>
