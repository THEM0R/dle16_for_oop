[not-group=5]
<a id="login" class="h_btn login" href="{profile-link}" title="{login}, повідомлень {new-pm}">
...
<div id="loginpane" class="droptopbar loggedpane">
	<div class="wrp">
		<div class="name">
			Привіт, <a href="{profile-link}"><b>{login}</b></a>!
		</div>
		<ul class="login_menu">
			<li>
