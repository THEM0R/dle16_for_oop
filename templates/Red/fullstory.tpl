			...
			<div id="storyinfo_{news-id}" class="storyinfo collapse">
				<div class="storyinfo_box">
					...
					<ul class="meta">
						...
						<li class="meta_views grey" title="Переглядів: {views}">
							<svg class="icon icon-meta_views"><use xlink:href="#icon-meta_views"></use></svg>{views}
						</li>
						<li class="meta_coms grey" title="Коментарів: {comments-num}">
			...
			<div class="story_left_icons">
				<div class="story_icons">
					...
					<div class="fav_btn">
						...
						[del-favorites]<span title="Прибрати з закладок"><svg class="icon icon-fav"><use xlink:href="#icon-fav"></use></svg></span>[/del-favorites]
					</div>
					<div class="edit_btn" title="Редагувати">
						[edit]<i title="Редагувати"></i>[/edit]
					</div>
					[/not-group]
					[rating]
					<div class="rate">
...
<div class="fullstory_foot shadow">
	<div class="wrp">
		...
		<div class="block col_news">
			<div class="block_title"><h4 class="ultrabold">Схожі новини</h4></div>
			<div class="grid_list">
				{related-news}
			</div>
		</div>
...
<div class="block comments shadow">
	<div class="wrp">
		<h4 class="block_title ultrabold">Коментарів {comments-num}</h4>
		<div class="com_list">
			{comments}
		</div>
	</div>
