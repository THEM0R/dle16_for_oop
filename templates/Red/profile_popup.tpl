<div class="popup_userinfo[online] useronline[/online] clrfix">
	...
	<ul class="usinf">
		...
		<li><div class="ui-c1 grey">Був на сайті</div> <div class="ui-c2">{lastdate}</div></li>
		<li><div class="ui-c1 grey">Зареєстрований</div> <div class="ui-c2">{registration}</div></li>
		<li><div class="ui-c1 grey">Новин: </div> <div class="ui-c2">{news-num} [ {news} ] [ [rss]RSS[/rss] ]</div></li>
		<li><div class="ui-c1 grey">Коментарів</div> <div class="ui-c2">{comm-num} [ {comments} ]</div></li>
	</ul>
</div>