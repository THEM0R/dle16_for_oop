	...
	<div class="wrp">
		...
		<div class="grid_3_4">
			<ul class="ui-form">
				...
				<li class="form-group">
					<a class="btn btn_border" href="#" onclick="$('.addvote').toggle();return false;">Додати опитування</a>
				</li>
				...
				<li class="form-group addvote" style="display:none;" >
					<label for="vote_body">Варіанти відповідей</label>
					<p class="grey">Кожен новий рядок є новим варіантом відповіді</p>
					...
					<div class="checkbox">
						...
						<label for="allow_m_vote">Дозволити вибір декількох варіантів</label>
					</div>
				</li>
				<li class="form-group imp">
			...
			<div class="form_submit">
				...
				[/sec_code]
				<button class="btn" type="submit" name="add"><b class="ultrabold">Додати</b></button>
				<button id="add_news_preview" class="btn btn_border" onclick="preview()" type="submit" name="nview"><b class="ultrabold">Перегляд</b></button>
			</div>
		</div>
	</div>
</article>