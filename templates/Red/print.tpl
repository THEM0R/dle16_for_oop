...
<head>
	...
	<title>DataLife Engine > Версія для друку > {title}</title>
	<link rel="canonical" href="{full-link}">
</head>
<body>
	<div class="top"><a href="/">DataLife Engine</a> / [full-link]{title}[/full-link]</div>
	<h1 class="title">{title}</h1>
	<div class="text">
	{full-story}
	</div>
	<div class="meta">{date}</div>
	<a class="back" href="javascript:history.go(-1)">Повернутися назад</a>
</body>
</html>