<div class="comment[comments-author] com_author[/comments-author]" id="{comment-id}">
	...
	<div class="com_content">
		...
		<div class="com_tools">
			...
			<span class="edit_btn" title="Редагувати">
			[com-edit]<i></i>[/com-edit]
			</span>
			[/not-group]
			<div class="com_tools_links grey">
				[fast]<svg class="icon icon-meta_reply"><use xlink:href="#icon-meta_reply"></use></svg><span>Цитувати</span>[/fast]
				[treecomments] 
					[reply]<svg class="icon icon-meta_reply"><use xlink:href="#icon-meta_reply"></use></svg><span>Відповісти</span>[/reply]
				[/treecomments] 
				[com-del]<svg class="icon icon-cross"><use xlink:href="#icon-cross"></use></svg><span>Видалити</span>[/com-del]
