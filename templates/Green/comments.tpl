<div class="comment[online] online[/online]" id="{comment-id}">
	...
	[not-group=5]
		...
		<span class="edit_btn">
		[com-edit]
			<i title="Редактировать">Редагувати</i>
		[/com-edit]
		</span>
	[/not-group]
		<div class="com_tools_links grey">
			[fast]<svg class="icon icon-reply"><use xlink:href="#icon-reply"></use></svg><span>Цитувати</span>[/fast]
			[treecomments] 
			...
			[com-del]<svg class="icon icon-del"><use xlink:href="#icon-del"></use></svg><span>Видалити</span>[/com-del]
		</div>
	</div>
</div>