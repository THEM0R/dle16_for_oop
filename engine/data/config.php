...
'http_home_url' => 'http://localhost/',

'description' => 'Демонстраційна версія DataLife Engine',

'keywords' => 'DataLife, Engine, CMS',

'short_title' => 'Демонстраційний сайт',
...
'offline_reason' => 'Сайт перебуває на реконструкції, а після завершення всіх робіт він буде відкритий.<br><br>Вибачте нам за спричинені незручності.',
...
'admin_mail' => 'slavik.mor.ua@gmail.com',
